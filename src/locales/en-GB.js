...
const enGB = {
  'en-GB': {
    translation: {
      meta_deposit_limits_title: 'Bede Casino | Deposit Limits | The safest place to play',
      meta_featured_title: 'Bede Casino | Featured Games | The safest place to play',
      meta_forgot_password_title: 'Bede Casino | Forgot Password | The safest place to play',
      ...
      meta_promotions_title: 'Bede Casino | Promotions | The safest place to play',
      ...
      meta_tables_title: 'Bede Casino | Play Table Games | The safest place to play',
      dob: 'Date of Birth',
